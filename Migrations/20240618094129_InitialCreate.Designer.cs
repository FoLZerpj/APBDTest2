...
namespace APBDTest2.Migrations
{
    ...
    [Migration("20240618094129_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("APBDTest2.Models.Author", b =>
                {
            ...
            modelBuilder.Entity("APBDTest2.Models.Book", b =>
                {
            ...
            modelBuilder.Entity("APBDTest2.Models.Genre", b =>
                {
            ...
            modelBuilder.Entity("APBDTest2.Models.PublishingHouse", b =>
                {
            ...
            modelBuilder.Entity("APBDTest2.Models.Book", b =>
                {
                    b.HasOne("APBDTest2.Models.PublishingHouse", "PublishingHouse")
                        .WithMany()
            ...
            modelBuilder.Entity("AuthorBook", b =>
                {
                    b.HasOne("APBDTest2.Models.Author", null)
                        .WithMany()
                        .HasForeignKey("AuthorsIdAuthor")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("APBDTest2.Models.Book", null)
                        .WithMany()
            ...
            modelBuilder.Entity("BookGenre", b =>
                {
                    ...
                    b.HasOne("APBDTest2.Models.Genre", null)
                        .WithMany()
